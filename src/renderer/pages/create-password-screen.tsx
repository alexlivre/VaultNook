        ...
        <div className="w-full max-w-md space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-4">
                  ...
                  {VAULT_COLORS.map((c) => (
                    <button
                      ...
                      style={{
                        ...
                        boxShadow:
                          color === c.value
                            ? `0 0 0 2px var(--color-surface-base), 0 0 0 4px ${c.value}`
                            : 'none',
                      }}
                      title={c.label}
                    />
              ...
              {/* Password */}
              <div className="space-y-2">
                <Label htmlFor="password">Nova senha mestra</Label>
                <Input
                  id="password"
                  type="password"
              ...
              {/* Confirm Password */}
              <div className="space-y-2">
                <Label htmlFor="confirmPassword">Confirmar senha mestra</Label>
                <Input
                  id="confirmPassword"
                  type="password"
